...
<html lang="en">
    ...
    <body background="img\TRES.jpg" style="background-size: 100%">
    <div style="position: relative; left: 1200px">
        ...
        <h1 style="text-align: center; font-size: 45px ;text-shadow: 4px 2px #ffffff;">NOTAS</h1>
        <div class="container">
    <div class="row">
        <div class="col-md-3 col-sm-3 col-xs-3">
        </div>
        <div class="col-md-2 col-sm-2 col-xs-2">
            <h1 style="font-size: 18px; margin-top: 30px;color:#ffffff" >GRADO</h1>
            <input type="text" name="GRADO" placeholder="" style="width:150px; height:30px">
            
        </div>
        <div class="col-md-2 col-sm-2 col-xs-2">
            <h1 style="font-size: 18px; margin-top: 30px ;color:#ffffff" >PERIODO</h1>
