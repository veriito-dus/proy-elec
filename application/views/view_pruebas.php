...
<html lang="en">
    ...
    <body background="img\SEIS.jpg" style="background-size: 100%">
    <div style="position: relative; left: 1200px">
        ...
        <h1 style="text-align: center; font-size: 45px ;text-shadow: 4px 2px #F61AE2;">PRUEBAS SABER</h1>
        <div class="container">
    <div class="row">
        ...
        <form action="<?php echo base_url(); ?>index.php/view_inst/BUSCAR" method="post">
                <input type="submit" value="BUSCAR" class="btn btn-primary" style="width:110px; height:50px;">
         </form>
    </div>
...
<div class="container">
    <div class="row">
        ...
        <form action="<?php echo base_url(); ?>index.php/view_inst/DESCARGAR" method="post">
                <input type="submit" value="DESCARGAR" class="btn btn-primary" style="width:150px; height:50px;">
         </form>
    </div>
</div>
